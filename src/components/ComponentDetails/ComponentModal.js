...
const mapStateToProps = state => {
  if (state.chart.selected !== undefined && state.chart.selected.type === 'node'){
      ...
      return { node: state.chart.nodes[selected_id], properties:  state.chart.nodes[selected_id].properties, sharedVariables: state.sharedVariables };
  } else{
      return {};
  }
}
      ...
      <>
        ...
        >
          <div className="modal-header">
            <h3 class="modal-title text-muted">{this.getType()}&nbsp;</h3>
