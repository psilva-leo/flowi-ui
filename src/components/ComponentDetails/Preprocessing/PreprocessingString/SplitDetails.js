...
const explodeSplitOptions = [
  { value: 'true', label: 'True' },
  { value: 'false', label: 'False' },
]

export class SplitDetails extends React.Component {
    ...
    render () {
      return (
          <>
            ...
            <Row>
              {actions.createText(4, 'Pattern', 'Pattern.', this.props.handleChange('delimiter'), this.props.nodeAttributes.delimiter)}
              {actions.createNumber(4, 'Limit', 'Limit', this.props.handleChange('limit'), this.props.nodeAttributes.limit, 100, -1, 1)}
              {actions.createSelect(4, 'Explode Split', 'Explode resulting list into rows.', explodeSplitOptions, this.props.nodeAttributes.explode_split, false, true, false, this.props.handleChange('explode_split'))}
            </Row>
            <hr className="my-1" />
